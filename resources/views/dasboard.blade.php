...
<body>
    ...
    <header id="header">
        <div class="d-flex flex-column">
            ...
            <div class="profile">
                <img src="assets/img/Tirta1.jpg" alt="" class="img-fluid rounded-circle">
                <h1 class="text-light"><a href="index.html">Tirta Putra Lasmana</a></h1>
    ...
    <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
        <img src="assets/img/Tirta.jpg" style="position: absolute;" id="hero" alt="">
        <div class="hero-container" data-aos="fade-in">
            <h1>{{ $data->name }}</h1>
            <p>I'm <span class="typed"
                    data-typed-items="Netwok Engineer, Network Operation Center, System Engineer"></span></p>
        </div>
    </section><!-- End Hero -->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4" data-aos="fade-right">
                        <img src="assets/img/Tirta.jpg" class="img-fluid" alt="">
                    </div>
                    <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                        <h3>Network Operation Center &amp; Web Developer.</h3>
                        <p class="fst-italic">
                        ...
                        <?php
                            $tanggal_lahir = new DateTime("1999-06-07");
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <ul>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Nick Name:</strong>
                                        <span>Tirta</span></li>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>7 June
                                            1999</span></li>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong>
                                        <span>{{ $data->mail }}</span></li>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong>
                                        <span>{{ $data->telephone }}</span></li>

                                </ul>
                            </div>
                            <div class="col-lg-6">
                                <ul>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Age:</strong> <span>{{ $thn }}</span></li>
