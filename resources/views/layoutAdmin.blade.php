...
<head>
  ...
  <!-- BS Stepper -->
  <link rel="stylesheet" href="{{ asset('assetsAdmin/plugins/bs-stepper/css/bs-stepper.min.css') }}">
  <!-- dropzonejs -->
  <link rel="stylesheet" href="{{ asset('assetsAdmin/plugins/dropzone/min/dropzone.min.css') }}">
  <!-- Theme style -->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url('/listData') }}" class="nav-link">
...
<script src="{{ asset('assetsAdmin/plugins/inputmask/jquery.inputmask.min.js') }}"></script>
<!-- date-range-picker -->
...
<!-- BS-Stepper -->
<script src="{{ asset('assetsAdmin/plugins/bs-stepper/js/bs-stepper.min.js') }}"></script>
<!-- dropzonejs -->
<script src="{{ asset('assetsAdmin/plugins/dropzone/min/dropzone.min.js') }}"></script>
<!-- AdminLTE App -->
